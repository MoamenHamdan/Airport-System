...
public class main {
	...
	public static void main(String[] args) {
		...
		while (choice != -1) {
			...
			case -1:
				break;
			case 1:
				adminMenu(scan, admins, Flightqueue);
				break;
			case 2:
				userMenu(scan, passengers, Flightqueue);
				break;
			default:
	...
	private static void adminMenu(Scanner scan, adminQueue admins, Priorityqueue Flightqueue) {
	...
	private static void userMenu(Scanner scan, passenger_Linkedlist passengers, Priorityqueue Flightqueue) {
						...
						if (f != null) {
							...
							if (foundPassenger.getAccountBalance() >= f.ticketPrice) {
								...
								if (answer12.equalsIgnoreCase("yes")) {
									foundPassenger
											.setAccountBalance(foundPassenger.getAccountBalance() - f.ticketPrice);
